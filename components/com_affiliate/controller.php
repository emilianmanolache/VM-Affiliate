...
class AffiliateController extends JControllerLegacy {
	...
	function register() {
		...
		$affiliateMail->setSender(array($config->get('mailfrom' ), $config->get('fromname' )));
		
		$affiliateMail->setSubject(JText::sprintf("WELCOME_MESSAGE", $config->get('sitename' )));
		...
		$adminMail->addRecipient($config->get('mailfrom' ));
		
		$adminMail->setSender(array($config->get('mailfrom' ), $config->get('fromname' )));
		
		$adminMail->setSubject(JText::sprintf("NEW_AFFILIATE_REGISTERED_SUBJECT", $config->get('sitename' ) . "!"));
		
		$adminMail->setBody(JText::sprintf("NEW_AFFILIATE_REGISTERED_SUBJECT", $config->get('sitename' ) . "!") .
	...
	function lostPassword() {
		...
		$affiliateMail->setSubject(JText::sprintf("SEND_PASSWORD_SUBJECT", $config->get('sitename' )));
