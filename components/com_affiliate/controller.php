...
class AffiliateController extends JController {
	...
	function logout() {
		...
		$this->setRedirect(JRoute::_($vmaHelper->vmaRoute("index.php?option=com_affiliate&view=login"), false), JText::_("LOGOUT_SUCCESS"), "message");
	...
	function emails() {
		...
		if (!$affiliateMail->send()) {
			...
			$this->setRedirect(JRoute::_($vmaHelper->vmaRoute("index.php?option=com_affiliate&view=panel&subview=emails"), false), JText::sprintf("EMAIL_SENDING_SUCCESS", count($affiliateMail->bcc)));
