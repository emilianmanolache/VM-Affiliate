...
class AffiliateViewLostpassword extends JView {
    ...
    function display($tpl = null) {
		...
		!$params->get( 'page_title') ? $params->set( 'page_title', JText::_("AFFILIATE_PANEL") . " - " . JText::_("FORGOT_YOUR_PASSWORD")) : NULL;
