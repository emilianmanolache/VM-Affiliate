...
class AffiliateViewTerms extends JView {
    ...
    function display($tpl = null) {
		...
		$pathway->addItem( JText::_("AFFILIATE_PROGRAM_TERMS"), JRoute::_($ps_vma->vmaRoute('index.php?option=com_affiliate&view=terms')) );
