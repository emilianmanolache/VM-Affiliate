...
<div id="affiliateHomePanel">
    ...
    <div class="affiliateHomePanelIcon">
        ...
        <a href="<?php echo JRoute::_($ps_vma->vmaRoute("index.php?option=com_affiliate&view=panel&subview=summary")); ?>">
    ...
    <div class="affiliateHomePanelIcon">
        ...
        <a href="<?php echo JRoute::_($ps_vma->vmaRoute("index.php?option=com_affiliate&view=panel&subview=banners")); ?>">
    ...
    <div class="affiliateHomePanelIcon">
        ...
        <a href="<?php echo JRoute::_($ps_vma->vmaRoute("index.php?option=com_affiliate&view=panel&subview=emails")); ?>">
    ...
    <div class="affiliateHomePanelIcon">
        ...
        <a href="<?php echo JRoute::_($ps_vma->vmaRoute("index.php?option=com_affiliate&view=panel&subview=traffic")); ?>">
    ...
    <div class="affiliateHomePanelIcon">
        ...
        <a href="<?php echo JRoute::_($ps_vma->vmaRoute("index.php?option=com_affiliate&view=panel&subview=sales")); ?>">
    ...
    <div class="affiliateHomePanelIcon">
        ...
        <a href="<?php echo JRoute::_($ps_vma->vmaRoute("index.php?option=com_affiliate&view=panel&subview=payments")); ?>">
    ...
    <div class="affiliateHomePanelIcon">
        ...
        <a href="<?php echo JRoute::_($ps_vma->vmaRoute("index.php?option=com_affiliate&view=panel&subview=statistics")); ?>">
    ...
    <div class="affiliateHomePanelIcon">
        ...
        <a href="<?php echo JRoute::_($ps_vma->vmaRoute("index.php?option=com_affiliate&view=panel&subview=details")); ?>">
    ...
    <div class="affiliateHomePanelIcon">
        ...
        <a href="<?php echo JRoute::_($ps_vma->vmaRoute("index.php?option=com_affiliate&view=panel&subview=preferences")); ?>">
