...
if (count($this->categoryads) > 0) { 
    ...
    foreach ($this->categoryads as $categoryad) {

        echo "<tr style=\"text-align: left;\" class=\"affiliateDataRow\">";
            
        echo "<td>" . $categoryad["index"]		. "</td>";
        
        echo "<td>" . $categoryad["thumb"] 		. "</td>";
        
        echo "<td>" . $categoryad["name"]		. "</td>";
        
        echo "<td>" . $categoryad["html"] 		. "</td>";
        
        echo "<td>" . $categoryad["prev"]		. "</td>";
