...
class AffiliateViewLogin extends JView {
    ...
    function display($tpl = null) {
		...
		global $mainframe, $vmaSettings, $vmaHelper;
		...
		!$params->get( 'page_title') ? $params->set( 'page_title', JText::sprintf("WELCOME_MESSAGE", $config->getValue( 'config.sitename' ) )) : NULL;
		
		// set the pathway and page title

		$pathway->addItem( JText::_("LOGIN"), JRoute::_($vmaHelper->vmaRoute('index.php?option=com_affiliate&view=login')) );
