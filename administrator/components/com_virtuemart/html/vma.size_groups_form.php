...
if ($sizeGroupID) {
	...
	$sizeGroup		= $ps_vma->_db->loadObject();

}

// include number validation function

$numberValidationFunction		= $ps_vma->numberValidationFunction("integer");

$document->addScriptDeclaration($numberValidationFunction);

?>

<form action="<?php echo $link . "page=vma.size_groups_list"; ?>" method="post" name="adminForm">
    ...
    <div class="affiliateAdminPage" <?php 
        ...
        <div class="adminPanelTitleIcon" id="adminSizeGroupsEditIcon">
                ...
                <div>
                    ...
                    <div style="float: right; text-align: center; margin-top: 10px;">
                        ...
                        <a class="toolbar" href="javascript:void(0);" id="affiliateCancelSizeGroup">
                            ...
                            <div class="vmicon-32-cancel" type="Standard"></div><?php 
                            
                                echo $VM_LANG->_("CMN_CANCEL");
                    ...
                    <div style="float: right; text-align: center; margin-top: 10px; margin-right: 20px;">
                        ...
                        <a class="toolbar" href="javascript:void(0);" id="affiliateSaveSizeGroup">
                            ...
                            <div class="vmicon-32-save" type="Standard"></div><?php 
                            
                                echo $VM_LANG->_("CMN_SAVE");
        ...
        <div class="affiliateTopMenu">
            ...
            <div class="affiliateTopMenuLink <?php
                ...
                <span style="background: url(<?php echo $ps_vma->_website; ?>components/com_affiliate/views/panel/tmpl/images/home_small.png) no-repeat left top;" 
                    ...
                    <a href="<?php echo $link . "page=vma.size_groups_list&amp;type=" . $type; ?>" id="affiliateReturnSizeGroup"><?php echo JText::_("SIZE_GROUPS"); ?></a>
            ...
            <div class="affiliateFormRow">
                ...
                <div class="affiliateDetailsValue" style="margin-top: 10px;">
                    ...
                    <span class="affiliateButton">
                        ...
                        <input type="hidden" name="page" 					value="vma.size_groups_list" />
                        
                        <input type="hidden" name="func"					value="vmaSizeGroupSave" />
                        ...
                        <input type="submit" value="<?php echo JText::_("SAVE"); ?>" style="width: auto;" 
                               ...
                               class="affiliateButton affiliateSaveButton" />
