...
<div class="affiliateAdminPage">
    ...
    <div class="adminPanelTitleIcon" id="adminAboutIcon">
    
        <h1 class="adminPanelTitle"><?php echo JText::_("ABOUT"); ?> VM Affiliate 4.5</h1>
    ...
    <div id="aboutContainer">
        ...
        <img src="<?php echo $ps_vma->_website . "components/com_affiliate/assets/images/virtuemartaffiliate.png"; ?>" alt="VM Affiliate" 
        ...
        <p>
            ...
            VM Affiliate is a Joomla!&trade; 1.5 native component, following the MVC design pattern to the letter, thus being easy to customize, either visually or featurewise. 
