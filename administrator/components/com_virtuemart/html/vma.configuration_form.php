...
$tooltipImage			= $ps_vma->_website . "components/com_affiliate/assets/images/info.png";
...
$GLOBALS["vmaSettings"] = $vmaSettings = $ps_vma->_db->loadObject();
...
$amountValidation 	= $ps_vma->numberValidationFunction("float");
						  
$document->addScriptDeclaration($amountValidation);

// add number validation function

$numberValidation 	= $ps_vma->numberValidationFunction("integer");

$document->addScriptDeclaration($numberValidation);

// add calendar class

$document->addScript($ps_vma->_website 		. "components/com_affiliate/assets/js/calendar.js");

// add calendar stylesheet

$document->addStyleSheet($ps_vma->_website 	. "components/com_affiliate/assets/css/calendar.css");
...
<form action="<?php echo $link . "page=vma.configuration_form"; ?>" method="post" name="adminForm">
        ...
        <div class="affiliateTopMenu">
            ...
            <div class="affiliateTopMenuLink">
                ...
                <span style="background: url(<?php echo $ps_vma->_website; ?>components/com_affiliate/views/panel/tmpl/images/home_small.png) no-repeat left top;" 
                    ...
                    <a href="<?php echo $link . "page=vma.summary"; ?>"><?php echo JText::_("SUMMARY"); ?></a>
                ...
                <div class="affiliateFormRow">
                    ...
                    <div class="affiliateDetailsValue affiliateCommissionInputs">
                        ...
                        <select id="affiliateOfflineTrackingType" name="offline_type">
                            ...
                            <option value="1" <?php echo $vmaSettings->offline_type == 1 ? "selected=\"selected\"" : NULL; ?>><?php echo JText::_("USERNAME"); ?></option>
                ...
                <div class="affiliateFormRow">
                    ...
                    <div class="affiliateDetailsValue affiliateCommissionInputs" style="margin-top: 10px;">
                        ...
                        <span class="affiliateButton">
                            ...
                            <input type="hidden" name="page" 			value="vma.configuration_form" />
                            
                            <input type="hidden" name="func"			value="vmaConfigurationUpdate" />
