...
class VirtuemartControllerVma_affiliates extends JControllerLegacy {
	...
	function affiliateAdd() {
		...
		$affiliateMail->setSender(array($vmaHelper->_config->get('mailfrom' ), $vmaHelper->_config->get('fromname' )));
		
		$affiliateMail->setSubject(JText::sprintf("WELCOME_MESSAGE", $vmaHelper->_config->get('sitename' )));
		...
		$affiliateMail->setBody(JText::sprintf("WELCOME_EMAIL", "\r\n\r\n", $newAffiliate["username"] . "\r\n\r\n", 
								...
								"\r\n" . $vmaHelper->_config->get('sitename' ) . "\r\n" . $vmaHelper->_website));
