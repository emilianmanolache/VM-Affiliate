			...
			?>
                    ...
                    <span class="affiliateFilterMenu">
                        ...
                        <span>
                            ...
                            <a href="<?php echo $link . "_sales&amp;confirmed=" . $confirmed . "&amp;paid=" . $paid; ?>"><?php echo ucwords(JText::_("ALL")); ?></a>
    ...
    <table class="adminlist" cellspacing="0" cellpadding="0">
        ...
        <thead>
            ...
            <tr>
                ...
                <th><input type="checkbox" name="toggle" value="" onclick="checkAll('<?php echo count($this->sales); ?>')" /></th>
