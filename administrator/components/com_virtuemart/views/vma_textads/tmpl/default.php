    ...
    <table class="adminlist jgrid table table-striped" cellspacing="0" cellpadding="0">
        ...
        <thead>
            ...
            <tr>
                ...
                <th class="admin-checkbox"><input type="checkbox" name="toggle" value="" onclick="checkAll('<?php echo count($this->textads); ?>')" /></th>
			...
			if (count($this->textads) > 0) {
				...
				foreach ($this->textads as $key => $textad) {
		    		...
		    		<tr class="row<?php echo $k ; ?>">
                        ...
                        <td><?php echo $vmaHelper->itemToggleButton($textad->textad_id, "textad", $textad->published); ?></td>
                        
                        <!-- add delete button -->
                        
                        <td><?php echo $vmaHelper->itemDeleteButton($textad->textad_id, "textad"); ?></td>
