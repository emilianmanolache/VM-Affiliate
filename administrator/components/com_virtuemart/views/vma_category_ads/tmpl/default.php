    ...
    <table class="adminlist jgrid table table-striped" cellspacing="0" cellpadding="0">
        ...
        <thead>
            ...
            <tr>
                ...
                <th class="admin-checkbox"><input type="checkbox" name="toggle" value="" onclick="checkAll('<?php echo count($this->categoryAds); ?>')" /></th>
			...
			if (count($this->categoryAds) > 0) {
				...
				foreach ($this->categoryAds as $key => $categoryad) {
		    		...
		    		<tr class="row<?php echo $k ; ?>">
                        ...
                        <td><?php echo $vmaHelper->itemToggleButton($categoryad->categoryID, "categoryad", ($categoryad->categoryPublished == '0' ? 0 : 1)); ?></td>
