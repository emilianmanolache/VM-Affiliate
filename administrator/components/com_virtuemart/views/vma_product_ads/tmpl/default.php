    ...
    <table class="adminlist jgrid table table-striped" cellspacing="0" cellpadding="0">
        ...
        <thead>
            ...
            <tr>
                ...
                <th class="admin-checkbox"><input type="checkbox" name="toggle" value="" onclick="checkAll('<?php echo count($this->productAds); ?>')" /></th>
			...
			if (count($this->productAds) > 0) {
				...
				foreach ($this->productAds as $key => $productad) {
		    		...
		    		<tr class="row<?php echo $k ; ?>">
                        ...
                        <td><?php echo $vmaHelper->itemToggleButton($productad->productID, "productad", ($productad->productPublished == '0' ? 0 : 1)); ?></td>
