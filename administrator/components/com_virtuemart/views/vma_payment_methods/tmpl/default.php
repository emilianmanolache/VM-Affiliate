    ...
    <table class="adminlist jgrid table table-striped" cellspacing="0" cellpadding="0">
        ...
        <thead>
            ...
            <tr>
                ...
                <th class="admin-checkbox"><input type="checkbox" name="toggle" value="" onclick="checkAll('<?php echo count($this->methods); ?>')" /></th>
			...
			if (count($this->methods) > 0) {
				...
				foreach ($this->methods as $key => $method) {
		    		...
		    		<tr class="row<?php echo $k ; ?>">
                        ...
                        <td><?php echo $vmaHelper->itemToggleButton($method->method_id, "paymentmethod", $method->method_enabled); ?></td>
                        
                        <!-- add affiliate delete button -->
                        
                        <td><?php echo ($method->method_id > 1 ?
