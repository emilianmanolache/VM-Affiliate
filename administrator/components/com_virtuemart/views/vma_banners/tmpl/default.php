    ...
    <table class="adminlist jgrid table table-striped" cellspacing="0" cellpadding="0">
        ...
        <thead>
            ...
            <tr>
                ...
                <th class="admin-checkbox"><input type="checkbox" name="toggle" value="" onclick="checkAll('<?php echo count($this->banners); ?>')" /></th>
			...
			if (count($this->banners) > 0) {
				...
				foreach ($this->banners as $key => $banner) {
		    		...
		    		<tr class="row<?php echo $k ; ?>">
                        ...
                        <td><?php echo $vmaHelper->itemToggleButton($banner->banner_id, "banner", $banner->published); ?></td>
                        
                        <!-- add delete button -->
                        
                        <td><?php echo $vmaHelper->itemDeleteButton($banner->banner_id, "banner"); ?></td>
