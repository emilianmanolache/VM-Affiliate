...
if ($bannerID) {
	...
	if (!file_exists($thumbnailImage) && file_exists($bannerLocation)) {
		...
		$vmaHelper->resizeImage($bannerLocation, $banner->banner_image, "thumbbig");
...
JToolBarHelper::title(JText::_("BANNER_FORM") . ($bannerID ? ": " . $banner->banner_name : NULL), 'head adminBannersIcon');
...
$vmaHelper->initiateAdForm("banners", (!$bannerID ? "add" : "edit"), (!$bannerID ? NULL : $banner));
...
<form action="<?php echo $link . "_banners"; ?>" method="post" name="adminForm">
                ...
                <div class="affiliateDetailsValue affiliateLongerInputs" style="width: auto;"><?php
					...
					if ($bannerID) {
						...
						?><div id="imageThumbnail" style="clear: both;">
                        		...
                        		<img src="<?php echo $vmaHelper->_website . "components/com_affiliate/thumbs/" . $thumbFilename; ?>" 
            ...
            <div class="affiliateFormRow">
                ...
                <div class="affiliateDetailsValue affiliateLongerInputs">
                	...
                	<?php
						...
						echo $vmaHelper->getLinksRow("banners", (!$bannerID ? "add" : "edit"), (!$bannerID ? NULL : $banner));
