            ...
            <thead>
                ...
                <tr>
                    ...
                    <?php if (!$modal) { ?>
                        ...
                        <th class="admin-checkbox"><input type="checkbox" name="toggle" value="" onclick="checkAll('<?php echo count($this->sizegroups); ?>')" /></th>
                ...
                if (count($this->sizegroups) > 0) {
                    ...
                    foreach ($this->sizegroups as $key => $sizegroup) {
                        ...
                        <tr class="row<?php echo $k ; ?>">
                            ...
                            <td><?php echo $vmaHelper->itemDeleteButton($sizegroup->size_group_id, "sizegroup") .
