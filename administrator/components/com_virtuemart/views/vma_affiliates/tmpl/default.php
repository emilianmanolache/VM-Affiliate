    ...
    <table class="adminlist" cellspacing="0" cellpadding="0">
        ...
        <thead>
            ...
            <tr>
                ...
                <th style="text-align: left;"><?php echo JText::_("EDIT"); ?></th>
			...
			if (count($this->affiliates) > 0) {
				...
				foreach ($this->affiliates as $key => $affiliate) {
		    		...
		    		<tr class="row<?php echo $k ; ?>">
                        ...
                        <td><?php echo ($mustBePaid ? "<a style=\"float: right;\" href=\"" 	. ($affiliate->method == "1" ? $vmaHelper->getPayPalLink($affiliate) : $link 				. 
							  ...
							  $this->methodsNames[$affiliate->method]["image"] . ".png\" " 	. "alt=\"Pay\" /></a>" : NULL) . "<span style=\"vertical-align: middle; float: right; " 	. 
                        ...
                        <td style="text-align: center;"><?php echo $vmaHelper->itemToggleButton($affiliate->affiliate_id, "affiliate", $affiliate->blocked); ?></td>
                        
                        <!-- add affiliate commission rates button -->
                        
                        <td style="text-align: center;"><?php echo $vmaHelper->affiliateRatesButton($affiliate->affiliate_id); ?></td>
                        
                        <!-- add affiliate edit button -->
                        
                        <td style="text-align: center;"><?php echo $vmaHelper->affiliateEditButton($affiliate->affiliate_id); ?></td>
                        
                        <!-- add affiliate delete button -->
                        
                        <td style="text-align: center;"><?php echo $vmaHelper->itemDeleteButton($affiliate->affiliate_id, "affiliate"); ?></td>
