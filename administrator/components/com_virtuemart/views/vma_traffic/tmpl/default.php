			...
			?>
                    ...
                    <span class="affiliateFilterMenu">
                        ...
                        <span>
                            ...
                            <a href="<?php echo $link . "_traffic&amp;unique=" . $unique . "&amp;paid=" . $paid; ?>"><?php echo ucwords(JText::_("ALL")); ?></a>
			...
			if (count($this->traffic) > 0) {
				...
				foreach ($this->traffic as $key => $traffic) {
		    		...
		    		<tr class="row<?php echo $k ; ?>">
                        ...
                        <td style="width: <?php echo $affiliateID ? "500" : "400"; ?>px;"><?php echo $traffic->RefURL ? $traffic->RefURL : JText::_("NONE"); ?></td>
