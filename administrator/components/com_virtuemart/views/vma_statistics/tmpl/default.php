...
JToolBarHelper::title(JText::_("STATISTICS"), 'head adminStatisticsIcon');
...
$link1			= $link . "_statistics&amp;type=" 		. $type 	. "&amp;period=";

$link2			= $link . "_statistics&amp;period=" 	. $period 	. "&amp;type=";

// get active statistics menus

$activeMenus	= $vmaHelper->getActiveStatsMenus();

// get statistics data

$statsData		= $vmaHelper->getStatisticsData($request);
...
<div class="affiliateAdminPage">
    ...
    if ($statsData) {
        ...
        <div id="affiliateStatisticsGraph">
            ...
            <img src="<?php echo $vmaHelper->_website . "components/com_affiliate/statistics/" . md5("admin") . $type . $period; ?>.png" alt="<?php echo JText::_("STATISTICS"); ?>" />
