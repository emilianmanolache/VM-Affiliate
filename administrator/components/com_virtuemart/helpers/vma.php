			...
			$linksRow				.=	  '<option value="" disabled="disabled" id="urlProductListSeparator"></option>
										  ...
										  <optgroup label="' . 
												...
												foreach ($products as $product) {
													...
													$productLink =	 JRoute::_("index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=" . $product->product_id);
			...
			$linksRow				.=	  '<option value="" disabled="disabled"></option>
										  ...
										  <optgroup label="' . 
												...
												foreach ($categories as $category) {
													...
													$categoryLink =	 JRoute::_("index.php?option=com_virtuemart&view=category&virtuemart_category_id=" . $category->category_id);
		...
		if ($form == "add" || $type == "textads") {
			...
			$sendSizeGroupForm	= "// function to send the size group form via ajax
								   ...
								   function sendSizeGroupForm() {
									  ...
									  var saveSizeGroup = new Ajax('" . str_replace("&amp;", "&", $adminLink) . "_sizegroups&modal=true&type=" . $type . "', {
