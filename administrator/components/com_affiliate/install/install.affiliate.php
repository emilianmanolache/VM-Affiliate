...
class com_affiliateInstallerScript {
	...
	public function postflight() {
		...
		$versionXML				= $vmDestinationPath . DS . "vmaInstall.xml";
		...
		if (!$updatedMenus) {
			...
			$this->insertMenuItem("INSERT INTO #__menu VALUES ('', 'mainmenu', 'Affiliates', 'affiliates', '', 'affiliates', 'index.php?option=com_affiliate&view=login', 'component', 1, 1, 1, '" . $componentID . "', 99, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '', __LFT__, __RGT__, 0, '*', 0)");
		...
		if ((!$upgrade && !$reinstall) || $upgradeFromVM20) {
			...
			$query				= "INSERT INTO #__virtuemart_userfields (`virtuemart_userfield_id`, `virtuemart_vendor_id`, `name`, " . 
								  ...
								  "`shipment`, `account`, `readonly`, `calculated`, `sys`, `params`, `ordering`, `shared`, `published`, " . 
	...
	function uninstall() {
		...
		$this->insertMenuItem("INSERT INTO #__menu VALUES ('', 'main', 'com_affiliate', 'comaffiliate', '', 'comaffiliate', 'index.php?option=com_affiliate', 'component', 1, 1, 1, '" . $componentID . "', 0, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', __LFT__, __RGT__, 0, '', 1)");
