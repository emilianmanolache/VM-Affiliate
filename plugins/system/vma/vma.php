...
class plgSystemVma extends JPlugin {
	...
	function onAfterInitialise() {
		...
		!class_exists("vmaHelper") ? require_once( JPATH_ROOT . DIRECTORY_SEPARATOR . "administrator" . DIRECTORY_SEPARATOR . "components" . DIRECTORY_SEPARATOR . "com_virtuemart" . DIRECTORY_SEPARATOR . "helpers" . DIRECTORY_SEPARATOR . "vma.php" ) : NULL;
	...
	function onAfterDispatch() {
		...
		$language->load("com_affiliate", JPATH_ROOT, $activeLanguage, true);
		...
		if ($vmaFrontend || $vmaAdministration) {
			...
			$includeAria	= $jVersion->getShortVersion() >= 2.5 ? 'this.win.setProperty(\'aria-hidden\', \'false\');' : NULL;
